...
public class MainBuku{
	public static void main(String[] args) {
		...
		System.out.println(book.jumlah_harga(75000, 7500));
                ...
                shop.namapen();
                shop.alamatt();
                InterfacePemimjam pem1 = new InterfacePemimjam();
                System.out.println("-------Pemimjam Pertama--------");
                pem1.namap();
                pem1.nimp();
                pem1.kelasp();
                InterfacePemimjam2 pem2 = new InterfacePemimjam2();
                System.out.println("--------Pemimjam Kedua---------");
                pem2.namap();
                pem2.nimp();
                pem2.kelasp();
